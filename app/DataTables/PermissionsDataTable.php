...
class PermissionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('assigned_to', function (Permission $permission) {
                ...
                return view('admin.pages.user-management.permissions.columns._assign-to', compact('roles'));
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(0)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/admin/pages/user-management/permissions/columns/_draw-scripts.js')) . "}");
    }
