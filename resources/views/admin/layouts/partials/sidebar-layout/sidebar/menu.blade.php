                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <!--begin::Username-->
                                    <a href="{{ route('admin.user-management.users.show', $data) }}" class="text-white text-hover-primary fs-6 fw-bold">{{ $data->name}}</a>
                                    <!--end::Username-->
                                    <div>
                                        
                                    <!--begin::Description-->
                                    <a href="{{ route('admin.user-management.users.show', $data) }}">
                                        @if($data->role=='client')
                                            <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Accepted</span>
                                        @else
                                            <span type="submit" class="badge badge-light-danger fw-bolder fs-8 px-2 py-1 ms-2">Not yet Accepted</span>
                                        @endif
                                    </a>
                                    <!--end::Description-->
                                    </div>
